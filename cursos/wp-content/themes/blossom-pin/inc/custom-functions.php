...
add_filter( 'comment_reply_link', 'blossom_pin_custom_comment_reply_link' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=blossom-pin-getting-started' ) ); ?>" class="button button-primary" style="text-decoration: none;"><?php esc_html_e( 'Go to the getting started.', 'blossom-pin' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?blossom-pin-update-notice=1"><?php esc_html_e( 'Dismiss','blossom-pin' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function blossom_pin_ignore_admin_notice() {
    ...
    if ( isset( $_GET['blossom-pin-update-notice'] ) && $_GET['blossom-pin-update-notice'] = '1' ) {
