...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://docs.blossomthemes.com/docs/' . BLOSSOM_PIN_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'blossom-pin' ); ?>" target="_blank"><?php esc_html_e( 'View Documentation', 'blossom-pin' ); ?></a>
    </div><!-- .panel-aside -->
    
    <div class="panel-aside">
        <h4><?php esc_html_e( 'Support Ticket', 'blossom-pin' ); ?></h4>
        <p><?php printf( __( 'It\'s always a good idea to visit our %1$sKnowledge Base%2$s before you send us a support ticket.', 'blossom-pin' ), '<a href="'. esc_url( 'https://docs.blossomthemes.com/docs/' . BLOSSOM_PIN_THEME_TEXTDOMAIN . '/' ) .'" target="_blank">', '</a>' ); ?></p>
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://demo.blossomthemes.com/' . BLOSSOM_PIN_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-pin' ); ?>" target="_blank"><?php esc_html_e( 'View Demo', 'blossom-pin' ); ?></a>
    </div><!-- .panel-aside -->
</div>
