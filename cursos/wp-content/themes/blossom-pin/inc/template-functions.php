...
function blossom_pin_page_start(){ ?>
    <div id="page" class="site"><a aria-label="skip to content" class="skip-link" href="#content"><?php esc_html_e( 'Skip to Content','blossom-pin' ); ?></a>
    <?php
}
endif;
...
if( ! function_exists( 'blossom_pin_after_page_end' ) ) :
/**
 * Page End
*/
function blossom_pin_after_page_end(){ 
...
add_action( 'blossom_pin_after_footer', 'blossom_pin_after_page_end', 30 );
