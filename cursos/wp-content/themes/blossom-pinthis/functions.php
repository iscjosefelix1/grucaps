...
function blossom_pinthis_customizer_register( $wp_customize ) {
    ...
    $theme_info = '<p>';
	$theme_info .= sprintf( __( 'Demo Link: %1$sClick here.%2$s', 'blossom-pinthis' ),  '<a href="' . esc_url( 'https://demo.blossomthemes.com/blossom-pinthis/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p><p>';
...
function blossom_pin_banner(){
    ...
    $banner_subtitle   = get_theme_mod( 'banner_subtitle', __( 'Discover how people in the community looks create pins to get their attention?', 'blossom-pinthis' ) );
