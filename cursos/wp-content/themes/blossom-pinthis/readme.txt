...
Blossom PinThis WordPress Theme, Copyright 2018 blossomthemes.com
Blossom PinThis is distributed under the terms of the GNU GPL

This program is free software: you can redistribute it and/or modify
it under the terms of the GNU General Public License as published by
the Free Software Fundation, either version 2 of the License, or
...
== Resources ==
https://pixabay.com/en/copy-space-craft-florist-floral-2518265/
https://pixabay.com/en/model-daisy-flowers-meadow-yellow-1955513/
https://pixabay.com/en/beautiful-beauty-bright-fashion-1852885/
...
== Changelog ==
    ...
    1.0.6 - October 22, 2019
        * Fixed: made breadcrumb color dynamic
    ...
    * Made footer link no-follow
    ...
    = 1.0.2 = 
    * solved issue of site title font not working
    * change the font of search placeholder

    = 1.0.1 = 
    * solved issue in responsive when it show add more posts
