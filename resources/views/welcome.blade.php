...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Gru-Caps &mdash; Grupo de Capacitación</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Cursos en linea Gru-Caps" />
	<meta name="keywords" content="Gru-Caps, Cursos, Capacitación, ingenieria, presupuestos, obras, Construcción" />
	<meta name="author" content="DevNaMi" />
		...
		<header id="fh5co-header-section" role="header" class="" >
			<div class="container">
				...
				<!-- <div id="fh5co-menu-logo"> -->
					<!-- START #fh5co-logo -->
					<h1 id="fh5co-logo" class="pull-left"><a href="index.html"><img src="images/logo-GCblanco.png" alt="Valet Free HTML5 Template"></a></h1>
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						...
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li>
								<a href="#" class="fh5co-sub-ddown">Categorias</a>
								 <ul class="fh5co-sub-menu">
								 	<li><a href="left-sidebar.html">Arquitectura</a></li>
								 	<li><a href="right-sidebar.html">Ingeniería civil</a></li>
									<li>
										<a href="#" class="fh5co-sub-ddown">Informatica</a>
										<ul class="fh5co-sub-menu">
											<li><a href="#" target="_blank">Java</a></li>
											<li><a href="#" target="_blank">SQL</a></li>
											<li><a href="#" target="_blank">Python</a></li>
											<li><a href="#" target="_blank">MongoDB</a></li>
											<li><a href="#" target="_blank">CSharp</a></li>
				...
				<div class="col-md-12">
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1">GRU-CAPS</h1>
							<h2 class="to-animate hero-animate-2">Grupo de <a href="#" target="_blank">Capacitación</a></h2>
							<p class="to-animate hero-animate-3"><a href="#" class="btn btn-outline btn-md">SUSCRIBETE</a></p>
						</div>
					</div>
				</div>
			</div>		
